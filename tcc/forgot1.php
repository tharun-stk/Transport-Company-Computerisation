...
$value=mysqli_query($conn,$msql);
$sql = "select * from employee where phone_no = $phone_no and   secret_key = '$secret_key'";
$result = mysqli_query($conn, $sql);

if (mysqli_num_rows($result) > 0) {
    $sql="update employee set password='$password' where phone_no=$phone_no";
...
form {border: 3px solid #f1f1f1;width:30%;height:50%;margin:auto;margin-top:10%}
